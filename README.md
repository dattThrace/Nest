...
folder. For example, to download the code specified in `377847.xml.xml`, please
run the following commands.

```shell
$ repo init -u https://nest-open-source.googlesource.com/manifests -b main -m nest_wifi_pro/377847.xml.xml
$ repo sync
```
